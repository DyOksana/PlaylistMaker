...
class AudioPlayerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val trackName = intent.getStringExtra("textTrackName")
        val artistName = intent.getStringExtra("textArtistName")
        val trackTime = intent.getStringExtra("textTrackTime")
        val collectionName = intent.getStringExtra("textCollectionName")
        val releaseDate = intent.getStringExtra("textReleaseDate")
        val primaryGenreName = intent.getStringExtra("textPrimaryGenreName")
        val country = intent.getStringExtra("textCountry")
